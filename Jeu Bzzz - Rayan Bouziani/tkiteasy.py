...
class Canevas(tk.Canvas):
    ...
    def __init__(self, parent: tk.Misc, largeur: float, hauteur: float) -> None:
        ...
        self.is_destroyed = False # Est-ce que la fenêtre à été détruite/fermée?
        ...
        self.bind('<Destroy>', self._evenementDestruction)
        self.pack()
    ...
    def _evenementDestruction(self, event: "tk.Event[Canevas]") -> None:
    ...
    def attendreTouche(self) -> str:
        ...
        while touche is None:
            if self.is_destroyed:
                raise Exception("La fenêtre n'existe plus, impossible de récupérer la touche")
    ...
    def attendreClic(self) -> "tk.Event[Canevas]":
        ...
        while clic is None:
            if self.is_destroyed:
                raise Exception("La fenêtre n'existe plus, impossible de récupérer le clic")
